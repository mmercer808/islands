...
async def emit_signal(signal_type: Union[SignalType, str], 
    ...
    if include_context and source_context_id:
        ...
        if source_context:
            ...
            from matts.serialization.context_serialization import HighPerformanceSignalBus
...
def create_callback_system(trusted_mode: bool = False):
    ...
    from matts.serialization.live_code_system import LiveCodeCallbackSystem
...
def serialize_source_code(source_code: str, name: str = "", 
    ...
    from matts.serialization.live_code_system import SourceCodeSerializer
