...
This package exists primarily to provide a stable namespace for tooling and
to expose the repo TODO list programmatically (useful for agents).

NOTE: In production, TODOs live in TODO.md. This module is a *mirror*.

"""

TODO_TEXT = r"""# TODO (island-engine)
